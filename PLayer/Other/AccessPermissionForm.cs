...
namespace STM
{
    public partial class AccessPermissionForm : Form
    {
        ...
        private void AcceptCommand_Click(object sender, EventArgs e)
        {
            ...
            {
                if (MessageBox.Show(this, Resources.AccessPermissionForm_AcceptCommand_Click, Resources.AccessPermissionForm_Error, MessageBoxButtons.RetryCancel, MessageBoxIcon.Asterisk) != DialogResult.Retry)
                {
