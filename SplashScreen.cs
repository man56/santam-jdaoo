...
namespace STM
{
	...
	public partial class SplashScreen : Form
	{
		...
		private int m_iShowAtLeastMilisec = 0;
		...
		static public void CloseForm(int milisecods = 0)
		{
			if (ms_frmSplash != null && ms_frmSplash.IsDisposed == false)
			{
				// Make it start going away.
				ms_frmSplash.m_iShowAtLeastMilisec = milisecods;
		...
		private void UpdateTimer_Tick(object sender, System.EventArgs e)
		{
			...
			else // Closing down splash screen
			{
				if (this.Opacity > 0)
				{
					if (ElapsedMilliSeconds() >= m_iShowAtLeastMilisec)
						this.Opacity += m_dblOpacityIncrement;
				}
				else
				{
